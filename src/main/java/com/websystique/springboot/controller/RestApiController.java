...
public class RestApiController {
	...
	public ResponseEntity<?> getEleve(@PathVariable("id") long id) {
		...
		if (eleve == null) {
			...
			return new ResponseEntity(new CustomErrorType("Eleve with id " + id + " not found"), HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<?> createEleve(@RequestBody Eleve eleve, UriComponentsBuilder ucBuilder) {
		...
		if (eleveService.isEleveExist(eleve)) {
			...
			return new ResponseEntity(
					new CustomErrorType("Unable to create. A Eleve with name " + eleve.getName() + " already exist."),
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> getMoniteur(@PathVariable("id") long id) {
		...
		if (moniteur == null) {
			...
			return new ResponseEntity(new CustomErrorType("Moniteur with id " + id + " not found"),
					HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<?> createMoniteur(@RequestBody Moniteur moniteur, UriComponentsBuilder ucBuilder) {
		...
		if (moniteurService.isMoniteurExist(moniteur)) {
			...
			return new ResponseEntity(
					new CustomErrorType(
							"Unable to create. A Moniteur with name " + moniteur.getNom() + " already exist."),
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> getProfil(@PathVariable("id") long id) {
		...
		if (profil == null) {
			...
			return new ResponseEntity(new CustomErrorType("Profil with id " + id + " not found"), HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<?> createProfil(@RequestBody Profil profil, UriComponentsBuilder ucBuilder) {
		...
		if (profilService.isProfilExist(profil)) {
			...
			return new ResponseEntity(
					new CustomErrorType(
							"Unable to create. A Profil with name " + profil.getIntituleProfil() + " already exist."),
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> createReservation(@RequestBody Reservation reservation, UriComponentsBuilder ucBuilder) {
		...
		if (reservationService.isReservationExist(reservation)) {
			logger.error("Unable to create. A Reservation with name {} already exist", reservation.getMoniteur() + " --"
					+ reservation.getEleve() + " --" + reservation.getLieuReservation());
			return new ResponseEntity(
					new CustomErrorType("Unable to create. A Reservation with name " + reservation.getMoniteur() + " --"
							+ reservation.getEleve() + " --" + reservation.getLieuReservation() + " already exist."),
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> deleteReservation(@PathVariable("id") long id) {
		...
		if (reservation == null) {
			...
			return new ResponseEntity(
					new CustomErrorType("Unable to delete. Reservation with id " + id + " not found."),
					HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<List<FactureMoniteur>> listAllFacturesMoniteurByMoniteur(
			@RequestParam(value = "nom") String nom) {// @PathVariable String nom) {
	...
	public ResponseEntity<?> getFactureMoniteur(@PathVariable("id") long id) {
		...
		if (factureMoniteur == null) {
			...
			return new ResponseEntity(new CustomErrorType("Facture with id " + id + " not found"),
					HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<?> createFactureMoniteur(@RequestBody FactureMoniteur factureMoniteur,
		...
		HttpHeaders headers = new HttpHeaders();
		headers.setLocation(
				ucBuilder.path("/api/factureMoniteur/{id}").buildAndExpand(factureMoniteur.getId()).toUri());
		return new ResponseEntity<String>(headers, HttpStatus.CREATED);
	}
	...
	public ResponseEntity<List<FactureEleve>> listAllFacturesEleveByEleve(@RequestParam(value = "nom") String nom) {// @PathVariable
																													// String
																													// nom)
																													// {
	...
	public ResponseEntity<?> createFactureEleve(@RequestBody FactureEleve factureEleve,
			UriComponentsBuilder ucBuilder) {
		...
		if (factureEleveService.isFactureEleveExist(factureEleve)) {
			...
			return new ResponseEntity(new CustomErrorType(
					"Unable to create. A FactureEleve with name " + factureEleve.getNumFacture() + " already exist."),
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> createDocument(@RequestBody Document document, UriComponentsBuilder ucBuilder) {
		...
		if (documentService.isDocumentExist(document)) {
			...
			return new ResponseEntity(
					new CustomErrorType(
							"Unable to create. A Document with name " + document.getLibelle() + " already exist."),
					HttpStatus.CONFLICT);
		}
